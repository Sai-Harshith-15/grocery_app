              ...
              Container(
                ...
                child: ListView.builder(
                  itemCount: cartController
                      .cartItems.length, // Assuming 4 identical items
                  itemBuilder: (context, index) {
                    final item = cartController.cartItems[index];
                    final productId = item.productId;
                    // if (!cartController.productDetails.containsKey(productId)) {
                    //     cartController.fetchSingleProductByCategory(productId);
                    //   }
                    //    final product = cartController.productDetails[productId];
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: CustomCheckboxListTile(
                          ...
                          subtitle: HeadText(
                              text:
                                  '${item.productQuantity} KG, ${item.price}'),
                          trailing: Column(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      cartController.decrementQuantity(
                                          item.cartId, item.quantity.value);
                                    },
                                    child: Container(
                                      width: 28,
                                      height: 28,
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Checkbox(
                                    value:
                                        false, // This will always be unchecked
                        ...
                        child: Container(
                          ...
                          child: Column(
                            mainAxisSize: MainAxisSize
                                .min, // Take the minimum space needed
                            children: [
                              ListTile(
                                leading: Image.asset(
